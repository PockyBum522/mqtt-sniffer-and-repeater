...
using MqttSnifferAndRelay.Core.Interfaces;
...
using MqttSnifferAndRelay.UI.TrayIcon;
using MqttSnifferAndRelay.UI.WindowResources.MainWindow;
using MqttSnifferAndRelay.UI.WindowResources.SettingsWindow;
...
public class DiContainerBuilder
{
    ...
    private void RegisterLogger(ILogger? testingLogger)
    {
        ...
        _logger = new LoggerConfiguration()
            .Enrich.WithProperty("MqttSnifferAndRelayApplication", "MqttSnifferAndRelaySerilogContext")
            .MinimumLevel.Debug()
    ...
    private void RegisterMainDependencies()
    {
        ...
        _builder.RegisterType<MqttWatcher>().AsSelf().SingleInstance();
    }
